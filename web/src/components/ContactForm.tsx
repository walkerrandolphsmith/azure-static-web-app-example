...
} from '@/constants/submissionFormMessages'
      ...
      >
        <div className="flex">
          ...
          <button
            ...
            type="submit"
            disabled={disabled}
            className="min-w-max px-4 py-2 bg-blue-1000 text-white rounded-3xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Pre-Order
          </button>
        </div>
